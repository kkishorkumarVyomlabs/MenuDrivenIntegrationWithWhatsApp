...
public class WhatsApp {
	...
	public static Actions actions = null;//new Actions(driver);
	...
	{		
		if(driver == null)
		{
			driver = DriverUtility.getDriver(whatsAppMain.browserLocation);
		...
		switch(userState)
		{
			case 1 :
						if (userReplay.equalsIgnoreCase("Hi")||userReplay.equalsIgnoreCase("Hello")||userReplay.equalsIgnoreCase("Hey")) 
						{
							...
							reply=reply+""+RequestDispatcher.requestProcess(userNo, "");
