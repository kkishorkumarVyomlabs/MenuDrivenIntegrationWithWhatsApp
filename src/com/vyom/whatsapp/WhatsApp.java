...
import com.vyom.chatbot.core.ReadChatBotMenuXML;
import com.vyom.chatbot.core.RequestDispatcher;
import com.vyomChatBot.whatsAppMain;
...
//							reply = RequestDispatcher.requestProcess(userNo, userReplay);
							reply = RequestDispatcher.requestProcess(userNo, "");
//							reply = reply+""+readChatBotMenuXML.MenuOptions(userNo,"");			//get menu list from XML file
						...
						break;
			case 2 : 	
//						reply = reply+""+readChatBotMenuXML.MenuOptions(userNo,userReplay);
						reply = RequestDispatcher.requestProcess(userNo, userReplay);
						sendMessage(userNo, reply);
