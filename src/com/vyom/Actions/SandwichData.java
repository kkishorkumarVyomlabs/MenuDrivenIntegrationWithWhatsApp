...
public class SandwichData extends AbstractServiceImpl{
	
	public void preProcessing() 
	{
		ChatBotLogger.logger.info("From Sandwich data preProcessing");
	}
	...
	{
		ChatBotLogger.logger.info("From Sandwich data postProcessing");
	}
	
	
	
	public void validateSandwichTypeValue(String input) throws Exception 
	{
	        ...
	        } else 
	        {
	           // System.out.println("It is a not number");
	            ChatBotLogger.logger.info("In SandwichData class validate first Value : " + input);
	        }
	...
	public void validateHowManySandwichValue(String input) throws Exception
	{
		if(Integer.parseInt(input)>0) 
		{
		ChatBotLogger.logger.info("In SandwichData class validate second Value :" + input);
